...
export const findMany = async (
  ...
  if (dto.isPrinted) queryParameters.append('is_printed', String(dto.isPrinted));
  ...
  if (dto.discDiameter) queryParameters.append('disc_diametr', dto.discDiameter);
  ...
  if (dto.tiresDiameter) queryParameters.append('tires_diametr', dto.tiresDiameter);
  ...
  if (dto.tiresCarType) queryParameters.append('tires_car_type', dto.tiresCarType);
  ...
  if (dto.tiresSeason) queryParameters.append('tires_season', dto.tiresSeason);
